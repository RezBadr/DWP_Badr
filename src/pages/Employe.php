    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container" style="margin:15px;padding:10px;border-radius:  15px; ; background-color:gray">
                    <h2 class="pb-2" style="text-align:center ;">Les rendez-vous </h2>
                    <div class="table-responsive">
                        <?php 
      include("../assets/php/connexion.php");
      $taches = $pdo->query('SELECT * FROM rendezvous WHERE Complete=false ');
      echo '<table class="table table-hover table-dark   table-sm  table-bordered">';
        echo '<thead>';
            echo '<tr>';
