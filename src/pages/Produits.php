...
<body>
    ...
    <div class="container-fluid">
        ...
        if(isset($_POST['valider'])){
          ...
          try{
          ajouter($marque,$image,$image2,$image3,$image4,$prix,$desc,$categorie,$ville,$car,$modele,$anneemodele);
        ...
        ?>
                ...
                <div class="container" style="padding:20px;">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="AjouterPiece-tab" data-bs-toggle="tab"
                                data-bs-target="#AjouterPiece" type="button" role="tab" aria-controls="AjouterPiece"
                                aria-selected="false">Ajouter une piece de rechange</button>
                        </li>
                    </ul>
                   ...
                   while($ligne = $req->fetch()){
                     echo '<li class="list-group-item">';
                        echo $ligne['categorie']." - ".$ligne['nom']." - ".$ligne['Ville']." - ".$ligne['anneemodele'];
                     echo '</li>';
                   }
                   echo '</ol>'
            ?>
                        ...
                        <div class="tab-pane fade" id="AjouterVoiture" role="tabpanel"
                            ...
                            <form action="" method="POST">
                                <div
                                    style="border: 2px #000 solid; border-radius:10px; margin-top:15px;padding:10px;background-color:rgb(255, 193, 7);">
                        ...
                        <div class="tab-pane fade" id="AjouterPiece" role="tabpanel" aria-labelledby="AjouterPiece-tab">
                            <form action="" method="POST">
                                <div
                                    style="border: 2px #000 solid; border-radius:10px; margin-top:15px;padding:10px;background-color:rgb(255, 193, 7);">
                                    ...
                                    <div class="mb-3">
                                        <label for="piece" class="form-label">Nom de la piece</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" list="datalistType" name="type"
                                            required>
                                        <datalist id="datalistType">
                                            <option value="Electicite">Electicite</option>
                                            <option value="GestionMoteur">Gestion dun Moteur</option>
                                            <option value="Direction&Suspension">Direction et Suspension</option>
                                            <option value="Caoutchouc_Metal">Caoutchouc-Metal</option>
                                            <option value="Distribution">Distribution</option>
                                            <option value="Transmission">Transmission</option>
                                            <option value="GestionThermique">Gestion Thermique du moteur</option>
                                            <option value="ComposantsMoteur">Composants du moteur</option>
                                            <option value="SystemeFreinage">Systeme de Freinage</option>
                                            <option value="Climatisation&Chauffage">Climatisation et Chauffage</option>
                                            <option value="Accessoires">Accessoires</option>
                                        </datalist>
                                    </div>
                                    <div class="mb-3">
                                        <label for="quantite" class="form-label">Quantité</label>
                                        <input type="number" class="form-control" name="qantite" required>
                                    </div>
                                    <hr class="my-4">
                                    <div class="d-grid gap-2 col-6 mx-auto">
                                        <button type="submit" name="valider2" class="btn btn-light">
                                            Ajouter
                                        </button>
                                    </div>
